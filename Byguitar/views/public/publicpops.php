        ...
        <dd>
            <div class="goinfo clearfix">
                <a class="fl" href="" id="pop_product_href">
                    <img width="160" id="pop_product_img" src="/images/shop/bpic-1.jpg" class="switch_item">
                </a>
            ...
            <div class="gobtn clearfix">
                <span class="btn btn-large btn-brown close">继续逛</span>
                <a class="btn btn-large btn-primary white" href="/cart/index">去结算</a>
            </div>
        </dd>
    </dl>
                ...
                <form name="formUser" method="post" action="/user/register" id="formUser">
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="dotab">
                        ...
                        <tr>
                            ...
                            <td valign="middle"><span class="yzm_box"><input type="text" class="do_input yzm_input" id="captcha" name="verify" /></span>
                                <img class="yzmimg" src="__ROOT__/public/verify/" width="50" height="26" />
                                <a tabindex="-1" class="qing cursor" id="yzmimglook">看不清？换一张</a></td>
                            <td align="left" valign="middle"><span></span></td>
                        </tr>
                        <tr>
                            ...
                            <td valign="middle"><label for="agree"><input type="checkbox" class="autologin" id="agree" checked="checked" name="agree" />
                                    我同意</label> <a class="brown" tabindex="-1" href="/public/agreement">《彼岸网使用协议》</a></td>
                            <td align="left" valign="middle"><span></span></td>
                        </tr>
                        <tr>
                            <td height="56" align="right" valign="middle">&nbsp;</td>
                            <td valign="middle">
                                <button type="button" class="btn btn-primary btn-large reg_btn" name="reg_btn">注&nbsp;&nbsp;册</button>已注册？
                                <a class="brown" id="pop_tolog">登录</a></td>
            ...
            <div class="pop_regform">
                <form method="post" action="/user/login" name="loginForm" id="loginForm">
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="dotab">
                        ...
                        <tr>
                            <td height="25" align="right" valign="middle">&nbsp;</td>
                            <td valign="middle"><input id="remember"  name="remember" checked="checked" type="checkbox" value="1" />
                                <label title="如果您在公共场合使用，请勿选择此项！" for="remember">下次自动登录</label></td>
                            <td align="left" valign="middle"><span></span></td>
                        </tr>
                        <tr>
                            <td height="56" align="right" valign="middle">&nbsp;</td>
                            <td valign="middle">
                                <button type="button" class="btn btn-primary btn-large login_btn" name="login_btn">登&nbsp;&nbsp;录</button>没注册？
                                <a class="brown" id="pop_toreg">注册</a></td>
                            <td valign="middle"><span></span>
                            </td>
                        </tr>
                    </table>
