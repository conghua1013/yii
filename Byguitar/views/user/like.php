                            ...
                            <?php if(!empty($list)): ?>
                                <?php foreach($list as $row): ?>
                                    <div class="fl pinbox spinbox shadow" pid="<?php echo $row['product_id']; ?>">
                                        <div class="pinimg">
                                            <?php if(isset($productList[$row['product_id']]) && $productList[$row['product_id']]['discount'] > 0): ?>
                                                <span class="discount"><?php echo $productList[$row['product_id']]['discount']; ?>折</span>
                                            <?php endif; ?>

                                            <span class="pinlike pinlike_on xinon del_like" title="点击取消喜欢"></span>
                                            <a href="/item/<?php echo $row['product_id']; ?>">
                                                <img width="180" height="180" src="<?php echo isset($productList[$row['product_id']]) ? $productList[$row['product_id']]['images']['image_300'] : ''; ?>" />
                                            </a>
                                        </div>
                                        <div class="pininfo">
